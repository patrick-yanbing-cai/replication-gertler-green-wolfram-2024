...
Continue to Issue #71 final M6 public handoff status and release-readiness decision; do not treat the repository as release-ready until that decision is complete.
