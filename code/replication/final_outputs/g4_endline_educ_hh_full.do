*** Purpose: Reproduce endline household education final table, including households without school-aged children.
...
foreach required_file in ///
    ...
    if _rc {
        display as error "Missing required staged input for g4_endline_educ_hh_full: `required_file'"
        exit 601
    }
}
